...
const Tips = () => {
  ...
  return (
    <div className={`${dark ? "bg-slate-200" : "bg-zinc-900" }`}>
      <Navbar />
      <section className={`${dark ? "bg-white" : "bg-black" } rounded-xl pb-12 mt-14 mr-4 ml-4`}>
       ...
       {!dark ?  <img
        ...
        <p className={`${dark ? "text-black" : "text-stone-250"} text-xl pl-8 pr-8 text-left `}>
